...
def _choose_best_model(ti):
    ...
    accuracies = ti.xcom_pull(
        key="model_accuracy",
        task_ids=[
            "processing_tasks._training_model_a",
            "processing_tasks._training_model_b",
            "processing_tasks._training_model_c",
        ],
    )
...
with DAG(
    ...
    choose_model = PythonOperator(task_id="choose_best_model", python_callable=_choose_best_model)

    is_accurate = BranchPythonOperator(task_id='is_accurate', python_callable=_is_accurate)
